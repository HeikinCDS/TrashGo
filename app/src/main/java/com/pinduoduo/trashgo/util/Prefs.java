...
public final class Prefs {
    ...
    private static final String KEY_TOUR_SEEN = "tour_seen";
    ...
    public static boolean tourSeen(@NonNull Context context) {
        return prefs(context).getBoolean(KEY_TOUR_SEEN, false);
    }

    public static void setTourSeen(@NonNull Context context, boolean seen) {
        prefs(context).edit().putBoolean(KEY_TOUR_SEEN, seen).apply();
    }
